# 0012: Add a source-engineering pipeline
...
- `@skizzles/source-engineering` owns immutable source captures, an authentic
...
- Reusing workspace-policy as a runtime dependency is rejected because it owns
  repository tooling and an executable surface; the source-engineering package
