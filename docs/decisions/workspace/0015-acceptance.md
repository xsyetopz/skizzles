...
Create `@skizzles/acceptance` as the sole Phase 6 acceptance aggregator.
...
`@skizzles/source-transformation` owns atomic generation epochs. It runs the full
...
four isolated verification profiles, acceptance evaluation, final
