...
package. Putting it in `plugin-builder` would mix runtime behavior with generated
...
- Extend `plugin-builder`: rejected because staging and runtime policy have different
