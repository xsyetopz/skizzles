...
async function normalizedModel(
  ...
  if (result.code === 0) {
    ...
    if (jsonModel !== undefined) return jsonModel;
  }
  ...
  if (yamlModel === undefined) throw composeConfigurationFailure();
  return yamlModel;
}
