...
it("the package facade imports without dispatching the command-line interface", async () => {
  const child = Bun.spawn(
    [
      process.execPath,
      "--eval",
      'const module = await import("@skizzles/command-observation"); if (typeof module.dispatchCommand !== "function" || typeof module.observeCommand !== "function" || typeof module.recoverCommandOutput !== "function") throw new Error("missing package facade");',
    ],
    {
      cwd: packageRoot,
      stdin: "pipe",
