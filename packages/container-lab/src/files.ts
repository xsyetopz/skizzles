...
import { canonicalDirectoryRoot } from "./trusted-filesystem.ts";
...
const STATE_NAME = /^[A-Za-z0-9][A-Za-z0-9._-]{0,127}$/;
...
export async function readUnknownJson(file: string): Promise<unknown> {
