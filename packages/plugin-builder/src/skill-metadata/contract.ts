...
export const INTERFACE_TEXT_MAX_LENGTH = 1024;
export const SHORT_DESCRIPTION_MIN_LENGTH = 25;
export const SHORT_DESCRIPTION_MAX_LENGTH = 64;
export const DEFAULT_PROMPT_MAX_LENGTH = 4096;
export const TOOL_TEXT_MAX_LENGTH = 1024;
export const TOOL_IDENTIFIER_MAX_LENGTH = 128;
export const TRANSPORT_MAX_LENGTH = 32;
...
export const BRAND_COLOR_PATTERN = /^#[0-9A-F]{6}$/u;
