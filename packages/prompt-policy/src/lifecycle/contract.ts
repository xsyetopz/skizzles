...
export const PROMPT_LAYER_ASSET_ROOT = "packages/prompt-policy/assets";
export const PROMPT_LAYER_SOURCE_PATHS = {
  ...
  shippedLanguagePolicy:
    "packages/prompt-policy/assets/evaluations/shipped-language-policy.v2.json",
} as const;
...
export const TRANSACTION_PATH = "packages/prompt-policy/assets/.transaction";
export const TRANSACTION_JOURNAL_PATH = `${TRANSACTION_PATH}/journal.json`;
export const LOCK_PATH = "packages/prompt-policy/assets/.mutation-lock";
