...
import { simpleCommands } from "../../hooks/manage-command-output/lexer.ts";
import { normalizeCommand } from "../../hooks/manage-command-output/normalize.ts";
import {
  isManagedScript,
  isRecognized,
} from "../../hooks/manage-command-output/policy.ts";
import type { SimpleCommand } from "../../hooks/manage-command-output/types.ts";
